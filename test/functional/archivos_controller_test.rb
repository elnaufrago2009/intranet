...
class ArchivosControllerTest < ActionController::TestCase
  ...
  test "should create archivo" do
    assert_difference('Archivo.count') do
      post :create, archivo: { contenido: @archivo.contenido, nombre: @archivo.nombre, resumen: @archivo.resumen, tipodocumento_id: @archivo.tipodocumento_id }
    end
  ...
  test "should update archivo" do
    put :update, id: @archivo, archivo: { contenido: @archivo.contenido, nombre: @archivo.nombre, resumen: @archivo.resumen, tipodocumento_id: @archivo.tipodocumento_id }
    assert_redirected_to archivo_path(assigns(:archivo))
  end
