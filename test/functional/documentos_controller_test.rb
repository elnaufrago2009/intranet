...
class DocumentosControllerTest < ActionController::TestCase
  ...
  test "should create documento" do
    assert_difference('Documento.count') do
      post :create, documento: { archivo_id: @documento.archivo_id, descripcion: @documento.descripcion, documentoimg: @documento.documentoimg, nombre: @documento.nombre, tipoformato: @documento.tipoformato }
    end
  ...
  test "should update documento" do
    put :update, id: @documento, documento: { archivo_id: @documento.archivo_id, descripcion: @documento.descripcion, documentoimg: @documento.documentoimg, nombre: @documento.nombre, tipoformato: @documento.tipoformato }
    assert_redirected_to documento_path(assigns(:documento))
  end
